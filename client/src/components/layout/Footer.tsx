        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Discover luxury and quality products for every lifestyle. Shop with confidence and style.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Get the latest updates, offers, and exclusive promotions.
            </p>
            <form className="flex flex-col space-y-2">
              <input
                type="email"
                placeholder="Your email address"
                className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600 text-white"
                required
              />
              <button
                type="submit"
